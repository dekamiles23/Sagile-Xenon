...
async function getSuggestedCommunities() {
  ...
  try {
    ...
    console.error('[SUPABASE] Erro ao buscar comunidades sugeridas:', err.message);
...
async function addSuggestedCommunity(community) {
  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .insert({
        ...
        banner_url: community.banner || null,

        icon_url: community.icon || null,

        members: community.members || 1,

        added_by: community.addedBy || 'unknown'
    ...
    console.error('[SUPABASE] Erro ao adicionar comunidade sugerida:', err.message);
...
async function removeSuggestedCommunity(communityId) {
...
// MENSAGENS DE CANAL DE SERVIDOR

// ================================================



async function saveServerMessage(msg) {
  ...
  try {
    ...
    console.error('[SUPABASE] Erro ao salvar mensagem do servidor:', err.message);
...
async function getServerMessageHistory(serverId, channel, limit = 100) {
  ...
  try {
    ...
    console.error('[SUPABASE] Erro ao buscar histórico do servidor:', err.message);
...
module.exports = {
  ...
  addSuggestedCommunity,

  removeSuggestedCommunity
