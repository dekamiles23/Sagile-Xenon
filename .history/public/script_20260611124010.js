...
// Evento de clique NAS CATEGORIAS (Anime, Jogos, Música, Arte, etc)
document.querySelectorAll('.community-category-option').forEach(btn => {
  btn.addEventListener('click', (e) => {
    e.preventDefault();
    e.stopPropagation();
    
    updateCommunityCategorySelection(btn);
