...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ✅ CORREÇÃO LAYOUT: Remover classe hidden IMEDIATAMENTE primeiro
  // Isso garante que o layout já está visível antes de qualquer outra operação
  appEl.classList.remove('hidden');
  
  // Forçar reflow do navegador para aplicar a alteração imediatamente
