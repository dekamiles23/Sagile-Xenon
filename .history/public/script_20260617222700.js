...
// ============================================================
// BARRA DE INPUT DO DM COM PICKERS FUNCIONAIS
// ============================================================
(function buildDmInputBar() {
  function buildBar() {
    const dmInputArea = document.getElementById('dm-input-area');
    if (!dmInputArea) return;

    // Cria a barra do zero (em vez de copiar)
    ...
    console.log('[DM] Barra construída com pickers funcionais');
  }
