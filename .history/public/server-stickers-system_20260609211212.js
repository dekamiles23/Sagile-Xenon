...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function loadServerStickers() {
    ...
    if (stickers.length === 0) {
      grid.innerHTML = '<div class="sticker-empty">Nenhuma figurinha adicionada ainda</div>';
      return;
    }
  ...
  function sendSticker(sticker) {
    ...
    showToast(`✅ Figurinha "${sticker.name}" enviada!`);
  }
  ...
  // ================================================
  // 5. UPLOAD DE NOVA FIGURINHA (APENAS DONO)
  // ================================================
  document.getElementById('btn-upload-sticker')?.addEventListener('click', () => {
    ...
    input.onchange = (e) => {
      ...
      reader.onload = (event) => {
        ...
        showToast(`✅ Figurinha "${newSticker.name}" adicionada!`);
      };
