...
// ============================================================
// UPLOAD DE AVATAR PARA AMIGO (COM BOTÃO NA LISTA)
// ============================================================
(function uploadFriendAvatar() {
  console.log('[UPLOAD] Iniciando...');

  // ── 1. Cria input de arquivo oculto ──
  ...
  fileInput.addEventListener('change', function(e) {
    ...
    reader.onload = function(event) {
      ...
      const key = 'avatar_' + targetUsername.toLowerCase();
      localStorage.setItem(key, base64);
      console.log('[UPLOAD] Avatar salvo para', targetUsername);
      alert('✅ Avatar de ' + targetUsername + ' atualizado!');

      // Força a recriação da lista
      if (typeof window.renderDmList === 'function') {
        window.renderDmList();
      } else {
        location.reload();
  ...
  // ── 4. Observa a lista para adicionar botões em novos itens ──
  function observeList() {
    ...
    setTimeout(addUploadButtons, 100);
  }

  // ── 5. Executa ao abrir a view DM ──
  const origShow = window.showLayout;
  if (origShow) {
    window.showLayout = function(layoutId) {
      origShow.call(this, layoutId);
      if (layoutId === 'dm-view') {
        setTimeout(addUploadButtons, 200);
      }
    };
  }
  ...
  console.log('[UPLOAD] Sistema ativo. Passe o mouse sobre o amigo na lista e clique em 📷.');
})();