...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function loadServerStickers() {
    ...
    if (!serverId) {
      grid.innerHTML = '<div class="sticker-empty">Selecione um servidor primeiro</div>';
      return;
    }
    ...
    // ✅ STICKERS PADRÃO SEMPRE APARECEM
    const defaultStickers = [
      { id: 'default_1', name: 'Feliz', url: 'https://cdn.discordapp.com/emojis/754716464668721274.png?v=1', isDefault: true },
      { id: 'default_2', name: 'Rindo', url: 'https://cdn.discordapp.com/emojis/754716464232382534.png?v=1', isDefault: true },
      { id: 'default_3', name: 'Amor', url: 'https://cdn.discordapp.com/emojis/754716464849166416.png?v=1', isDefault: true },
      { id: 'default_4', name: 'Wow', url: 'https://cdn.discordapp.com/emojis/754716465075798096.png?v=1', isDefault: true },
      { id: 'default_5', name: 'Triste', url: 'https://cdn.discordapp.com/emojis/754716463829516309.png?v=1', isDefault: true },
      { id: 'default_6', name: 'Raiva', url: 'https://cdn.discordapp.com/emojis/754716464018259998.png?v=1', isDefault: true },
      { id: 'default_7', name: 'Pensando', url: 'https://cdn.discordapp.com/emojis/754716465390366750.png?v=1', isDefault: true },
      { id: 'default_8', name: 'Joinha', url: 'https://cdn.discordapp.com/emojis/754716465579106314.png?v=1', isDefault: true },
      { id: 'default_9', name: 'Ok', url: 'https://cdn.discordapp.com/emojis/754716463611412541.png?v=1', isDefault: true },
      { id: 'default_10', name: 'Dance', url: 'https://cdn.discordapp.com/emojis/754716463175204874.gif?v=1', isDefault: true },
    ];

    // Juntar stickers padrão + customizados
    const allStickers = [...defaultStickers, ...stickers];
    ...
    allStickers.forEach(sticker => {
      ...
      stickerItem.innerHTML = `
        ...
        <div class="sticker-actions">
          <button class="sticker-btn-send" title="Enviar figurinha">📤</button>
          <button class="sticker-btn-preview" title="Ver figurinha">👁</button>
        </div>
      `;

      // Botão ENVIAR
      stickerItem.querySelector('.sticker-btn-send').addEventListener('click', (e) => {
        e.stopPropagation();
        sendSticker(sticker);
        stickerModal.classList.add('hidden');
      });
        ...
        <div class="sticker-preview-info">
          ...
          <button class="btn-neon" onclick="
            const msg = {
              ...
              stickerUrl: '${sticker.url}',
              stickerName: '${sticker.name}',
              username: localStorage.getItem('userNickname') || 'Usuário',
            ...
            if (area) {
              ...
              div.innerHTML = \`
                ...
                <div class="msg-body">
                  ...
                  <div class="sticker-container">
                    <img src="${sticker.url}" class="chat-sticker" />
                  </div>
                </div>
              \`;
            ...
            alert('✅ Figurinha enviada!');
          ">📤 ENVIAR FIGURINHA</button>
        </div>
      </div>
    `;
