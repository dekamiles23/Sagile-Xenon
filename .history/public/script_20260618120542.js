...
// ============================================================
// BOTÃO DE UPLOAD DE AVATAR (COM SOCKET.IO)
// ============================================================
(function uploadButton() {
  // Cria input de arquivo oculto (global, mas isolado)
  ...
  if (!fileInput) {
    ...
    fileInput.addEventListener('change', function(e) {
      ...
      reader.onload = function(ev) {
        ...
        socket.emit('upload-avatar', { username, avatar: base64 });
        alert('📤 Enviando avatar de ' + username);
      };
      reader.readAsDataURL(file);
      this.value = '';
    });
  ...
  console.log('[UPLOAD] Botões 📷 adicionados.');
})();