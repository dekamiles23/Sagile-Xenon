...
// ✅ CRIA A SETA DO ZERO E GARANTE QUE ELA SEMPRE EXISTA
setInterval(() => {
  ...
  if (sidebar) {
    ...
    // SE NÃO EXISTIR, CRIA ELE COMPLETAMENTE DO ZERO
    if (!btn) {
      ...
      // ADICIONA DIRETAMENTE NO BODY CONTORNANDO O BLOQUEIO
      document.body.insertBefore(btn, document.body.firstChild);
      console.log('✅ SETA CRIADA AUTOMATICAMENTE');
    }
    
    // Atualiza texto da seta
    btn.textContent = sidebar.classList.contains('collapsed') ? '▶' : '◀';
    
    // APLICA TODO CSS DIRETO NO ELEMENTO
    btn.setAttribute('style', `
      position: fixed !important;
      right: ${sidebar.classList.contains('collapsed') ? '0px' : '288px'} !important;
      top: 76px !important;
