...
function createServer(template) {
  ...
  // ✅ Correção: Esperar 100ms antes de abrir o servidor para evitar tela branca
  // Garante que o DOM foi completamente atualizado antes de inicializar o layout
  setTimeout(() => {
    openServer(id);
  }, 100);
}
