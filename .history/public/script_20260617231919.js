...
// ============================================================
// CORREÇÃO DE ENVIO DE MENSAGENS NO DM
// ============================================================
(function fixDmSend() {
  console.log('[DM-SEND] Aplicando correção de envio...');
  ...
  function sendDmMessage() {
    ...
    console.log(`[DM-SEND] Enviando para ${activeUser}: ${text}`);
    ...
    if (typeof window.sendDmMessage === 'function') {
      ...
      console.error('[DM-SEND] Nenhuma função de envio encontrada');
      return;
    }
  ...
  // ── Usa event delegation para capturar cliques no botão enviar ──
  document.addEventListener('click', function(e) {
  ...
  // ── Usa event delegation para capturar Enter no input ──
  document.addEventListener('keydown', function(e) {
    if (e.key === 'Enter' && !e.shiftKey) {
  ...
  // ── Também captura o evento "keypress" como fallback ──
  ...
  console.log('[DM-SEND] Correção aplicada com sucesso');
})();