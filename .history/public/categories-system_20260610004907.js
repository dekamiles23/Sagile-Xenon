...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function initDragAndDrop() {
    ...
    document.querySelectorAll('.ch-category-row').forEach(categoryHeader => {
      ...
      // ✅ PERMITIR ARRASTAR CLICANDO EM QUALQUER LUGAR DO CABEÇALHO
      categoryHeader.addEventListener('mousedown', () => {
        categoryHeader.style.cursor = 'grabbing';
      });
      ...
      categoryHeader.addEventListener('dragover', (e) => {
        ...
        if (e.clientY < midY) {
          sidebarChannels.insertBefore(dropIndicator, categoryHeader);
        } else {
          sidebarChannels.insertBefore(dropIndicator, categoryHeader.nextSibling);
        }
      ...
      categoryHeader.addEventListener('drop', (e) => {
        ...
        // ✅ ACEITA TANTO CANAIS QUANTO CATEGORIAS
        ...
        if (isCategory) {
          // Mover a categoria inteira junto com seus canais
        ...
        if (isChannel) {
          // Mover canal para o topo desta categoria
          ...
          if (channelsContainer && channelsContainer.classList.contains('category-channels')) {
            channelsContainer.insertBefore(draggedElement, channelsContainer.firstChild);
          }
        }
