...
function renderUsersList() {
  ...
  if (countEl) {
    // Conta APENAS usuários que estão realmente renderizados na tela
    const renderedUsers = container.querySelectorAll('.user-item').length;
    countEl.textContent = renderedUsers;
  }
