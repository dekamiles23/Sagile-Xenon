...
function sendDmMessage(text, toUsername) {
  ...
  // 🔥 SOLUÇÃO: usa o próprio nome do destinatário como receiverId (fallback)
  // Isso garante que o servidor sempre tenha um valor para rotear
  const receiverId = toUsername; 
  ...
  if (window.socket && window.socket.connected) {
    ...
    console.log('[DM] Enviado com receiverId:', receiverId);
  } else {
    console.warn('[DM] Socket off-line, mensagem perdida');
  }
