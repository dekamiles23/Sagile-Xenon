...
// ============================================================
// COPIA BARRA DE INPUT DO SERVIDOR PARA O DM
// ============================================================
(function copyInputBar() {
  function copyBar() {
    const dmInputArea = document.getElementById('dm-input-area');
    if (!dmInputArea) return;

    // Encontra a barra de input do servidor
    ...
    if (attachBtn) {
      ...
      fileInput.addEventListener('change', function() {
        console.log('[DM] Arquivo(s):', this.files);
        this.value = '';
      });
    }
    ...
    if (voiceBtn) {
      voiceBtn.addEventListener('click', () => {
        console.log('[DM] Gravação de áudio');
      });
    }

    console.log('[COPY] Barra do servidor copiada para o DM');
  }
  ...
  // Intercepta abertura da view DM
