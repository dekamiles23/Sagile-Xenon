...
// ============================================================
// FIX DEFINITIVO: PICKERS NO DM (movendo os existentes)
// ============================================================
(function fixDmPickersFinal() {
  // Lista de pickers a serem movidos
  const pickers = [
    { id: 'emoji-picker', btnId: 'dm-btn-emoji', itemSelector: '.emoji-item' },
    { id: 'gif-picker', btnId: 'dm-btn-gif', itemSelector: '.gif-item img' },
    { id: 'sticker-picker', btnId: 'dm-btn-stickers', itemSelector: '.sticker-item' }
  ];

  // Move os pickers para o body se existirem
  pickers.forEach(p => {
    const el = document.getElementById(p.id);
    if (el && el.parentNode !== document.body) {
      document.body.appendChild(el);
      console.log(`[DM-PICKER] ${p.id} movido para o body`);
    }
  });

  // Função para conectar um botão a um picker
  ...
  console.log('[DM-PICKER] Pickers movidos e conectados com sucesso');
})();