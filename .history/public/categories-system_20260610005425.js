...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function initDragAndDrop() {
    ...
    document.querySelectorAll('.ch-category-row').forEach(categoryHeader => {
      // ✅ PERMITIR ARRASTAR APENAS CLICANDO NO NOME DA CATEGORIA
      const categoryName = categoryHeader.querySelector('.cat-name') || categoryHeader;
      
      categoryName.draggable = true;
      categoryName.style.cursor = 'grab';
      categoryName.style.userSelect = 'none';

      categoryName.addEventListener('dragstart', (e) => {
