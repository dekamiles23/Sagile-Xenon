...
// ============================================================
// SOLUÇÃO DEFINITIVA: MUTATIONOBSERVER PARA CONECTAR BOTÕES
// ============================================================
(function dmPickersMutation() {
  console.log('[DM-MUTATION] Iniciando...');
  ...
  function createPickers() {
    const pickerConfigs = [
      ...
      {
        id: 'gif-picker',
        items: ['https://media.giphy.com/media/3o7aTskHEUdgCQAXde/giphy.gif','https://media.giphy.com/media/26tn33aiTi1jkl6H6/giphy.gif','https://media.giphy.com/media/3o6Zt481isNVuQI1l6/giphy.gif','https://media.giphy.com/media/l0HlNQ03J5JxX6lva/giphy.gif','https://media.giphy.com/media/3o7abKhOpu0N9H8s/giphy.gif','https://media.giphy.com/media/l0HlOBPvWqHj1D7J2/giphy.gif'],
        className: 'gif-item'
      },
      {
        id: 'sticker-picker',
    ...
    pickerConfigs.forEach(({ id, items, className }) => {
      ...
      if (!picker) {
        ...
        console.log(`[DM-MUTATION] Picker criado: ${id}`);
      }

      // Popula com itens
      if (!picker.querySelector(`.${className}`)) {
        const grid = document.createElement('div');
        grid.style.cssText = 'display:flex;flex-wrap:wrap;gap:6px;max-height:300px;overflow-y:auto;';
        if (id === 'gif-picker') {
        ...
        items.forEach(item => {
          ...
          el.style.cssText = 'cursor:pointer;padding:4px;border-radius:6px;';
          if (id === 'gif-picker') {
            ...
            el.textContent = item;
            el.style.fontSize = id === 'sticker-picker' ? '36px' : '28px';
            el.style.display = 'inline-block';
          }
          grid.appendChild(el);
        });
        picker.appendChild(grid);
        console.log(`[DM-MUTATION] Picker populado: ${id}`);
      }
    });
  }
  ...
  function togglePicker(pickerId) {
    ...
    if (!picker) {
      console.warn(`[DM-MUTATION] Picker ${pickerId} não existe`);
      return;
    }
    ...
    console.log(`[DM-MUTATION] ${pickerId} ${isActive ? 'aberto' : 'fechado'}`);
    if (isActive) {
      const input = document.getElementById('dm-message-input');
  ...
  // ── 3. CONECTA UM BOTÃO AO SEU PICKER ──
  function connectButton(btn) {
    const id = btn.id;
    const pickerMap = {
    ...
    newBtn.addEventListener('click', function(e) {
      e.preventDefault();
      e.stopPropagation();
      console.log(`[DM-MUTATION] Clique em ${id} → abrir ${pickerId}`);
      togglePicker(pickerId);
    });
    console.log(`[DM-MUTATION] Botão ${id} conectado`);
  }

  // ── 4. MUTATIONOBSERVER: DETECTA QUANDO OS BOTÕES APARECEM ──
  function observeButtons() {
    const observer = new MutationObserver(() => {
      ['dm-btn-emoji', 'dm-btn-gif', 'dm-btn-stickers'].forEach(id => {
    ...
    observer.observe(document.body, { childList: true, subtree: true });
    console.log('[DM-MUTATION] Observador iniciado');

    // Verifica botões já existentes
    ['dm-btn-emoji', 'dm-btn-gif', 'dm-btn-stickers'].forEach(id => {
      const btn = document.getElementById(id);
      if (btn && !btn.dataset.connected) {
        btn.dataset.connected = 'true';
  ...
  // ── 5. INSERE ITENS NOS PICKERS AO CLICAR ──
  document.addEventListener('click', function(e) {
    ...
    if (value) {
      ...
      console.log(`[DM-MUTATION] Inserido: ${value}`);
    }
  });
  ...
  // Reexecuta quando a view DM for aberta
  ...
  console.log('[DM-MUTATION] Script carregado. Aguardando botões...');
})();