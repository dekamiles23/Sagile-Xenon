...
// ✅ BOTÃO APARECE SOMENTE NA VIEW DO SERVIDOR
function createToggleButton() {
  // Verifica se estamos na view do servidor
  if (!document.querySelector('.server-view-container') && !document.querySelector('.server-chat-container')) {
    return;
  }
  ...
  console.log('✅ Botão toggle criado na view do servidor');
}
