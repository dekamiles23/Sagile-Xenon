...
// ============================================================
// RECRIA PICKERS COM LAYOUT ORGANIZADO (inline styles)
// ============================================================
(function fixPickersLayoutFinal() {
  function rebuildPickers() {
    ...
    console.log('[PICKERS] Layout recriado com inline styles');
  }

  // Executa após a criação da barra
  setTimeout(rebuildPickers, 150);
  setTimeout(rebuildPickers, 400);
  ...
  console.log('[PICKERS] Script de layout inline carregado');
})();