...
// ============================================================
// BARRA DM COMPLETA – CORREÇÃO DE EVENTOS
// ============================================================
(function dmBarFinal() {
  ...
  function createPickers() {
    ...
    pickers.forEach(({ id, items, className }) => {
      ...
      if (!picker.querySelector(`.${className}`)) {
        ...
        items.forEach(item => {
          ...
          if (id === 'gif-picker') {
            ...
            el.style.cssText = 'border-radius:8px;overflow:hidden;cursor:pointer;aspect-ratio:16/9;';
            ...
            el.className = className;
            el.textContent = item;
            el.style.cssText = `font-size:${id === 'sticker-picker' ? '36px' : '28px'};cursor:pointer;padding:4px;border-radius:6px;display:inline-block;`;
          }
          grid.appendChild(el);
        });
  ...
  function createBar() {
    ...
    wrapper.innerHTML = `
      <button type="button" id="dm-btn-plus" class="dm-action-btn" style="background:transparent;border:none;color:#ccc;font-size:18px;cursor:pointer;padding:4px;width:36px;height:36px;border-radius:50%;display:flex;align-items:center;justify-content:center;">➕</button>
      <button type="button" id="dm-btn-emoji" class="dm-action-btn" style="background:transparent;border:none;color:#ccc;font-size:18px;cursor:pointer;padding:4px;width:36px;height:36px;border-radius:50%;display:flex;align-items:center;justify-content:center;">😀</button>
      <button type="button" id="dm-btn-gif" class="dm-action-btn" style="background:transparent;border:none;color:#ccc;font-size:18px;cursor:pointer;padding:4px;width:36px;height:36px;border-radius:50%;display:flex;align-items:center;justify-content:center;">🎬</button>
      <button type="button" id="dm-btn-stickers" class="dm-action-btn" style="background:transparent;border:none;color:#ccc;font-size:18px;cursor:pointer;padding:4px;width:36px;height:36px;border-radius:50%;display:flex;align-items:center;justify-content:center;">🎭</button>
      <button type="button" id="dm-btn-attach" class="dm-action-btn" style="background:transparent;border:none;color:#ccc;font-size:18px;cursor:pointer;padding:4px;width:36px;height:36px;border-radius:50%;display:flex;align-items:center;justify-content:center;">📎</button>
      ...
      <button type="button" id="dm-btn-voice" class="dm-action-btn" style="background:transparent;border:none;color:#ccc;font-size:18px;cursor:pointer;padding:4px;width:36px;height:36px;border-radius:50%;display:flex;align-items:center;justify-content:center;">🎤</button>
    ...
    function connectButton(btnId, pickerId, isAttach = false, isMore = false) {
      const btn = document.getElementById(btnId);
      if (!btn) {
        console.warn(`[DM] Botão ${btnId} não encontrado`);
        return;
      }
      ...
      newBtn.addEventListener('click', function(e) {
        e.preventDefault();
        e.stopPropagation();
        console.log(`[DM] Clique em ${btnId}`);
        if (isAttach) {
      ...
      console.log(`[DM] Botão ${btnId} conectado`);
    }

    connectButton('dm-btn-emoji', 'emoji-picker');
    connectButton('dm-btn-gif', 'gif-picker');
    connectButton('dm-btn-stickers', 'sticker-picker');
    connectButton('dm-btn-plus', null, false, true);
    connectButton('dm-btn-attach', null, true);
  ...
  console.log('[DM] Script completo carregado');
})();