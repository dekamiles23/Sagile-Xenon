...
// ============================================================
// BOTÃO 📷 SEMPRE VISÍVEL NA LISTA DE DMs
// ============================================================
(function visibleUploadButton() {
  console.log('[VISIBLE] Iniciando...');
  ...
  function addButtons() {
    document.querySelectorAll('#dm-conversations-list .dm-conv-item').forEach(item => {
      ...
      console.log('[VISIBLE] Botão adicionado para', friendName);
    });
  }
  ...
  console.log('[VISIBLE] Botões 📷 sempre visíveis.');
})();