...
// Fandom DOM
createFandomModal       = document.getElementById('create-fandom-modal');
newFandomNameInput      = document.getElementById('new-fandom-name');
newFandomDescInput      = document.getElementById('new-fandom-desc');
...
let createFandomModal = null;
let newFandomNameInput = null;
let newFandomDescInput = null;
