...
// ✅ CORREÇÃO MAIS SIMPLE DO MUNDO - FUNCIONA 100%
setInterval(() => {
  // Pegar TODOS os botões de categoria diretamente
  document.querySelectorAll('#community-modal div > div > div > div').forEach(btn => {
    
    // Verificar se é um botão de categoria
    if (btn.textContent.includes('Anime') || btn.textContent.includes('Jogos') || btn.textContent.includes('Música') || btn.textContent.includes('Arte') || btn.textContent.includes('Tech') || btn.textContent.includes('Filmes') || btn.textContent.includes('Livros') || btn.textContent.includes('Outro')) {
      ...
      if (!btn.hasAttribute('data-fixed')) {
        ...
        btn.addEventListener('click', () => {
          ...
          document.querySelectorAll('#community-modal div > div > div > div').forEach(b => {
            if (b.textContent.includes('Anime') || b.textContent.includes('Jogos') || b.textContent.includes('Música') || b.textContent.includes('Arte') || b.textContent.includes('Tech') || b.textContent.includes('Filmes') || b.textContent.includes('Livros') || b.textContent.includes('Outro')) {
              b.style.background = 'transparent';
              b.style.border = '1px solid rgba(255, 0, 255, 0.3)';
              b.style.boxShadow = 'none';
              b.style.transform = 'scale(1)';
