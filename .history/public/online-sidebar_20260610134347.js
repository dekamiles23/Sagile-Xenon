...
// ✅ SISTEMA DE TOGGLE DA SIDEBAR COM ANIMAÇÃO PERFEITA
// Cria botão IMEDIATAMENTE no body, sem esperar nada
(function createToggleButton() {
  ...
  console.log('✅ Botão toggle sidebar CRIADO');
})();

// Atualiza posição do botão constantemente
setInterval(() => {
  const sidebar = document.querySelector('.online-sidebar');
  const btn = document.getElementById('toggle-online-sidebar');
  
  if (sidebar && btn) {
    if (!sidebar.classList.contains('collapsed')) {
      // Quando sidebar está aberta: botão fica DENTRO dela
      ...
      // Quando sidebar está fechada: botão fica fixo na borda
