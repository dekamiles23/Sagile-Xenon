...
// ============================================================
// COPIA BARRA DO SERVIDOR PARA DM (COM TODAS AS FUNCIONALIDADES)
// ============================================================
(function fullDmInputBar() {
  function copyBar() {
    ...
    // ──────────────────────────────────────────────────────────
    // 2. FUNÇÃO GENÉRICA PARA CONECTAR PICKERS
    // ──────────────────────────────────────────────────────────
    function setupPicker(btnId, pickerId, itemSelector, insertFn) {
    ...
    // 3. EMOJI
    // ──────────────────────────────────────────────────────────
    setupPicker('dm-btn-emoji', 'emoji-picker', '.emoji-item', function(text) {
      if (input) {
    ...
    // 4. GIF
    // ──────────────────────────────────────────────────────────
    setupPicker('dm-btn-gif', 'gif-picker', '.gif-item img', function(url) {
      if (input) {
        input.value += `[GIF] ${url} `;
      }
    });
    ...
    // 5. FIGURINHA (STICKER)
    // ──────────────────────────────────────────────────────────
    setupPicker('dm-btn-stickers', 'sticker-picker', '.sticker-item', function(text) {
      if (input) {
        input.value += text + ' ';
      }
    });
    ...
    // ──────────────────────────────────────────────────────────
    // 6. ANEXAR ARQUIVO (funcionalidade extra)
    // ──────────────────────────────────────────────────────────
    ...
    // ──────────────────────────────────────────────────────────
    // 7. GRAVAR ÁUDIO (funcionalidade extra)
    // ──────────────────────────────────────────────────────────
    ...
    console.log('[DM-INPUT] Barra copiada com todas as funcionalidades');
  }
