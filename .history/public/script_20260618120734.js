...
// ============================================================
// BOTÃO DE UPLOAD DE AVATAR (COM ESCOPO ISOLADO)
// ============================================================
(function uploadButtonIsolated() {
  ...
  // Função para adicionar botões nos itens da lista
  function addButtons() {
    const items = document.querySelectorAll('#dm-conversations-list .dm-conv-item');
    if (items.length === 0) {
      console.warn('[UPLOAD] Nenhum item encontrado');
      return;
    }
    items.forEach(function(item) {
      ...
      console.log('[UPLOAD] Botão adicionado para', friendName);
    });
  }
  ...
  if (list) {
    ...
    console.log('[UPLOAD] Observador ativado');
  }

  // Executa imediatamente e com delays
  addButtons();
  setTimeout(addButtons, 300);
  setTimeout(addButtons, 600);
  setTimeout(addButtons, 1000);

  console.log('[UPLOAD] Sistema pronto.');
})();