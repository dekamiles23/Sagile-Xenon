...
// Substitua pela sua imagem em base64
const minhaImagem = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUA...';
localStorage.setItem('avatar_milesdeka', minhaImagem);
// Força atualização da lista
if (typeof refreshAvatars === 'function') refreshAvatars();
else if (typeof window.refreshAvatars === 'function') window.refreshAvatars();
