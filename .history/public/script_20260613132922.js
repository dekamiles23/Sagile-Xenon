      ...
      centerArea.innerHTML = `
        ...
        <div class="dm-input-area">
          <div class="input-wrapper">
            ...
            <button id="dm-send-btn" type="button">➤</button>
          </div>
        </div>
      `;
    }
  ...
  for (const [cat, channels] of Object.entries(categories)) {
    ...
    catHeader.addEventListener('contextmenu', (e) => {
      ...
      ctxMenu.innerHTML = `
        ...
        <div class="ctx-item" data-action="rename-cat">✏️ Renomear categoria</div>
        <div class="ctx-item" data-action="move-up">⬆️ Mover para cima</div>
        <div class="ctx-item" data-action="move-down">⬇️ Mover para baixo</div>
        <div class="ctx-sep"></div>
  ...
  pane.innerHTML = friendRequests.map(r => `
    <div class="friend-card">
      ...
      <div class="friend-actions">
        ...
        <button class="friend-btn friend-btn-reject" data-reject="${escHtml(r.from)}">✖</button>
      </div>
    </div>`).join('');
